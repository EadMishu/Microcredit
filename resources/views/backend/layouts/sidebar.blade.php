<!-- Overlay-->
  ...
  <aside class="sidebar mt-2 position-fixed start-0 top-0 vh-100 d-flex flex-column" id="sidebar">
    <img src="{{asset('backend')}}/images/logo/logo.png" alt="Desktop Logo" class="d-md-none py-3 px-5">
    <!-- Start accordion wrapper -->
    <div class="flex-grow-1 overflow-y-auto">
      <ul class="nav flex-column gap-2 justify-content-center my-5" id="sidebarMenuAccordion">
    
        <!-- Dashboard menu -->
        <!-- <li class="nav-item mt-3"><a class="nav-link d-flex" href="#" data-bs-toggle="collapse" data-bs-target="#dashboard" aria-expanded="true">
        ...
        <!-- Apps menu -->
        <li class="nav-item">
          <a class="nav-link d-flex mt-3" href="#" data-bs-toggle="collapse" data-bs-target="#transaction" aria-expanded="false">
            <i class="bi bi-bank mx-1 fs-5"></i>
            <span class="ms-3">Accounce</span>
            <i class="bi bi-arrow-right-short arrow ms-auto"></i>
          </a>
          <ul class="submenu collapse fs-6 ms-3" id="transaction" data-bs-parent="#sidebarMenuAccordion">
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{route('transaction.index')}}">Transaction</a></li>
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{route('income.index')}}">Income</a></li>
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{route('balance.index')}}">Trial Balance </a></li>
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{route('amount.index')}}">Show all Transaction</a></li>
          </ul>
        </li>
        ...
        <!-- Pages menu start -->
        <li class="nav-item">
          <a class="nav-link d-flex" href="#" data-bs-toggle="collapse" data-bs-target="#pages" aria-expanded="false">
            <i class="bi bi-wallet2 mx-1 fs-5"></i>
            <span class="ms-3">Savings</span>
            <i class="bi bi-arrow-right-short arrow ms-auto"></i>
          </a>
          <ul class="submenu collapse fs-6 ms-3" id="pages" data-bs-parent="#sidebarMenuAccordion">
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{ route('savings.index') }}">All Information</a></li>
            <li class="nav-item list-unstyled"><a class="nav-link" href="/pages/blog.html">Add New</a></li>
        ...
        <!-- Auth menu start -->
        <li class="nav-item">
          <a class="nav-link d-flex" href="#" data-bs-toggle="collapse" data-bs-target="#authentication" aria-expanded="false">
            <i class="bi bi-wallet-fill mx-1 fs-5"></i>
        ...
        <!-- DPS start -->
        <li class="nav-item">
          <a class="nav-link d-flex" href="#" data-bs-toggle="collapse" data-bs-target="#charts" aria-expanded="false">
        ...
        <li class="nav-item">
          <a class="nav-link d-flex" href="#" data-bs-toggle="collapse" data-bs-target="#ecommerce" aria-expanded="false">
        ...
        <!-- E-commerce menu end -->
         ...
         <!-- expense start -->
        <li class="nav-item">
          <a class="nav-link d-flex" href="#" data-bs-toggle="collapse" data-bs-target="#expense" aria-expanded="false">
            <i class="bi bi-currency-exchange mx-1 fs-5"></i>
            <span class="ms-3">Expense</span>
            <i class="bi bi-arrow-right-short arrow ms-auto"></i>
          </a>
          <ul class="submenu collapse fs-6 ms-3" id="expense" data-bs-parent="#sidebarMenuAccordion">
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{ route('expense.index') }}">All Information</a></li>
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{ route('expense.create') }}">Add New</a></li>
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{ route('expense-types.index') }}">Type</a>
        ...
        <!-- Elements menu start -->
        <li class="nav-item">
          <a class="nav-link d-flex" href="#" data-bs-toggle="collapse" data-bs-target="#elements" aria-expanded="false">
        ...
        <!-- Forms menu start -->
        <li class="nav-item">
          <a class="nav-link d-flex" href="#" data-bs-toggle="collapse" data-bs-target="#forms" aria-expanded="false">
          ...
          <ul class="submenu collapse fs-6 ms-3" id="forms" data-bs-parent="#sidebarMenuAccordion">
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{ route('users.index') }}">All Members</a>
            </li>
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{ route('users.create') }}">Add new</a></li>
            <li class="nav-item list-unstyled"><a class="nav-link" href="{{ route('owner.index') }}">Owners</a></li>
