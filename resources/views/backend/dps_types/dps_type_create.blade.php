...
<main class="main-content px-3">
    ...
    <form action="{{ route('dps-types.store') }}" method="POST">
        @csrf

        <div class="card card-dark mb-3">
            <div class="card-header"><h5>DPS Type Information</h5></div>
            <div class="card-body">
                <div class="row gy-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="number_of_installments" class="form-control" value="{{ old('number_of_installments') }}" required>
            ...
            <div class="card-footer col-md-6">
                <button type="submit" class="btn btn-success form-control">Save DPS Type</button>
