...
<main class="main-content px-3">
    <h3 class="pt-3 text-muted">Add Loan Type</h3>
    ...
    <form action="{{ route('loan-types.store') }}" method="POST">
        ...
        <div class="card card-dark mb-3">
            <div class="card-header"><h5>Loan Type Information</h5></div>
            <div class="card-body">
                <div class="row gy-4">
            ...
            <div class="card-footer col-md-6">
                <button type="submit" class="btn btn-success form-control">Save Loan Type</button>
