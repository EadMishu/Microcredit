...
<main class="main-content px-3">
    <h3 class="pt-3 text-muted">Add New dps</h3>
    ...
    <form action="{{ route('dps.store') }}" method="POST">
        ...
        <div class="card card-dark mb-3">
            ...
            <div class="card-body">
                <div class="row gy-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="dps_number" class="form-control" value="{{ old('dps_number') }}">
                        @error('dps_number')
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="dps_type_id" class="form-control">
                            ...
                            @foreach ($dpsTypes as $type)
                                <option value="{{ $type->id }}" {{ old('dps_type_id') == $type->id ? 'selected' : '' }}>
            ...
            <div class="card-footer col-md-6">
                <button type="submit" class="btn btn-success  form-control ">Submit dps</button>
            </div>
        </div>
    </form>
</main>
